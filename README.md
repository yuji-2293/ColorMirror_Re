...
## 目次
- [ColorMirror\_Re(MVP版)](#colormirror_remvp版)
  - [目次](#目次)
  - [アプリ URL](#アプリ-url)
    - [テストアカウントを用意しています](#テストアカウントを用意しています)
  - [アプリイメージ画像](#アプリイメージ画像)
  - [アプリ使用スクリーンショット](#アプリ使用スクリーンショット)
    - [1. mood選択](#1-mood選択)
    - [2. colorの生成/選択](#2-colorの生成選択)
    - [3. AIコメントの生成](#3-aiコメントの生成)
    - [4. 記録データの保存、履歴の表示](#4-記録データの保存履歴の表示)
  ...
  - [開発背景](#開発背景)
    - [リプレイス開発で理解したかったこと](#リプレイス開発で理解したかったこと)
  - [👩‍💻 機能選定](#-機能選定)
    - [認証機能](#認証機能)
    - [基幹機能](#基幹機能)
    - [UI/UX](#uiux)
  ...
  - [🔧 技術スタック](#-技術スタック)
  - [設計意図（工夫）](#設計意図工夫)
    - [Zustandによる認証状態管理](#zustandによる認証状態管理)
    - [TanStack Queryを採用してServer Stateを管理](#tanstack-queryを採用してserver-stateを管理)
    - [React + Rails APIでのリプレイス開発を通して、責務設計の変化について](#react--rails-apiでのリプレイス開発を通して責務設計の変化について)
